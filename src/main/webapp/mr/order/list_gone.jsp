...
<body>
  <nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 已开会议<span class="c-gray en">&gt;</span> 已开会议  <a
          ...
          <c:if test="${!empty orderList }">
            <c:forEach var="order" items="${orderList }">
              <tr class="text-c">
                ...
                <td>${order.remark }</td>
                <td class="td-manage">
                  <a title="查看" href="javascript:;" onclick="viewOrder(${order.orderId})" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe665;</i></a> 
                </td>
              </tr>
            </c:forEach>
          </c:if>
