    ...
    <form action="orderAction" method="post" class="form form-horizontal" id="form-member-add">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          ...
          <input type="hidden" class="input-text" value="${user.userId}" id="userId" name="userId">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>预定会议室：</label>
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="${meetingRoom.roomName }" readonly>
          <input type="hidden" class="input-text" value="${meetingRoom.roomId}" id="roomId" name="roomId">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>预定日期：</label>
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" class="input-text" value="${orderDate}" placeholder="" readonly id="orderDate" name="orderDate">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>预定时间：</label>
        <div class="formControls col-xs-4 col-sm-3">
          <input type="text" class="input-text" value="" placeholder="" readonly id="starDatePlan" name="starDatePlan">
        </div>
        <div class="formControls col-xs-4 col-sm-3">
          <input type="text" class="input-text" value="" placeholder="" readonly id="endDatePlan" name="endDatePlan">
        </div>
      </div>
      <div class="row cl">
